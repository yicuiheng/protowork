...
text3d_t::text3d_t(glm::vec3 pos, int font_size, std::string const &str)
...
void text3d_t::draw(GLFWwindow *window, glm::mat4 const &m) {
    int screen_width, screen_height;
    glfwGetWindowSize(window, &screen_width, &screen_height);
    auto pos = m * glm::vec4{m_pos, 1.f};
    ...
    glUniform2f(font::size_id(), (float)screen_width, (float)screen_height);
